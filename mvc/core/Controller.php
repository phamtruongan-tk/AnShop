<?php
    class Controller{
        public $base_url = 'http://localhost/AnShop';
        public function Model($m){
            require_once './mvc/models/'.$m.'Model.php';
            return new $m;
        }
        public function ViewFrontend($v,$data =[]){
            require_once './mvc/views/frontend/'.$v.'.php';
        }
        public function ViewBackend($v,$data = []){
            require_once './mvc/views/backend/'.$v.'.php';
        }
